              ...
              {allBeatsLists.map((beat, index) => (
                <div className="beats-photo-title" key={index} onClick={() => handlePlayBeat(beat.src, beat.photo)}>
                  ...
                  <div className="download-cart">
                    <button onClick={() => handleDownload(beat.src)}> <span className="btnDownload-text">Download</span><span><img src="src/assets/download-icon.svg" alt="Download" /></span></button>
                    <button onClick={() => handleDownload(beat.src)}><img src="src/assets/cart-icon.svg" alt="Buy"/></button>
                  </div>
                </div>
