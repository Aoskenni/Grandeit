      ...
      <div className="licensing-pricing-container">
        ...
        <div className="licensing-lists">
          <div className="basic-license">
            ...
            </div><div className="licensing-br"><br /><br /></div>
          ...
          <div>
            ...
            <div className="features-listing">
              ...
              <span>Life Performances</span>
              <span>Radio Broadcast</span>
            </div><div className="licensing-br"><br /><br /><br /></div>
          ...
          <div>
            ...
            <div className="features-listing">
              ...
              <span>Life Performances</span>
              <span>Radio Broadcast</span>
            </div><div className="licensing-br"><br /><br /><br /><br /></div>
          ...
          <div>
            ...
            </div><div className="licensing-br"><br /><br /><br /><br /><br /></ div>
          ...
          <div>
            ...
            <div className="features-listing">
              ...
              <span>Life Performances</span>
              <span>Radio Broadcast</span>
            </div><div className="licensing-br"><br /><br /> <br /> <br /><br /><br /></div>
        ...
        <div className="faq">
            ...
            <div className="faq-text-btn">
                ...
                <p>Are you in need of more information regarding our <br className="faq-text-p" />products and services, or in need of a 
                detailed guide on <br className="faq-text-p" />how to purchase our digital products, click on the button.</p>
                </div>
