  ...
  return (
    <>
        ...
        <div className="about-us-body">
            <div className="about-us-grid about-us-grid-mobile">
                <div className="left-grid">
                  <div className="left-grid-contents">
                    ...
                    <div className="social-icons-container">
                      ...
                      <a href=""> <i className="fa-brands fa-facebook fa-l" style={{color:"#fff"}}></i> Facebbok</a>
                      <a href=""><i className="fa-brands fa-whatsapp fa-l" style={{color:"#fff"}}></i> Whatsapp</a>
                      <a href=""><i className="fa-brands fa-instagram fa-l" style={{color:"#fff"}}></i> Instagram</a>
                      <a href=""><i className="fa-brands fa-twitter fa-l" style={{color:""}}></i> Twitter</a>
                      <a href=""><i className="fa-brands fa-tiktok fa-l" style={{color:""}}></i> Tiktok</a>
                      <a href=""><i className="fa-brands fa-soundcloud fa-l" style={{color:"#fff"}}></i> SoundCloud</a>
                      <a href=""><i className="fa-brands fa-youtube fa-l" style={{color:""}}></i> Youtube</a>
                      <a href=""><i className="fa-brands fa-spotify fa-l" style={{color:""}}></i> Spotify</a>
                      </div>
